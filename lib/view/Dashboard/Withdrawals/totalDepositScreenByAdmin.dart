...
class AutoDepositByAdminScreen extends StatelessWidget {
  AutoDepositByAdminScreen({super.key});
  final TotalDepositByAdminController controller =
      Get.put(TotalDepositByAdminController());
